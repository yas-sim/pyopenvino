...
from pyopenvino.inference_engine import IENetwork, IECore
...
def main():
	...
	input_name    = net.inputs[0]['name']
	output_name   = net.outputs[0]['name']
	print('Input node name=', input_name, ' Output node name=', output_name)
	batch, c, h, w = net.inputs[0]['data']['shape']
	print('Input shape = ', net.inputs[0]['data']['shape'])
